...
namespace Samples
{
    ...
    public class OrderSamples
    {
        ...
        {
            //EXSTART::relativepeggedtoprimary::java
            Order order = new Order();
            order.Action = action;
            order.OrderType = "REL";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::auctionpeggedtostock::java
            Order order = new Order();
            order.Action = action;
            order.OrderType = "PEG STK";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::marketwithprotection::java
            Order order = new Order();
            order.Action = action;
        ...
        {
            //EXSTART::stopwithprotection::java
            Order order = new Order();
            order.TotalQuantity = quantity;
            order.Action = action;
        ...
        {
            //EXSTART::trailingstoplimit::java
            Order order = new Order();
            order.Action = action;
        ...
        {
            //EXSTART::limitorderforcombowithlegprices::java
            Order order = new Order();
            order.Action = action;
            order.OrderType = "LMT";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::relativelimitcombo::java
            Order order = new Order();
            order.Action = action;
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::relativemarketcombo::java
            Order order = new Order();
            order.Action = action;
            order.TotalQuantity = quantity;
