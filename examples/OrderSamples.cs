...
namespace Samples
{
    ...
    public class OrderSamples
    {
        ...
        {
            //EXSTART::marketiftouched::csharp
            Order order = new Order();
            order.Action = action;
            order.OrderType = "MIT";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::relativepeggedtoprimary::csharp
            Order order = new Order();
            order.Action = action;
            order.OrderType = "REL";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::auctionpeggedtostock::csharp
            Order order = new Order();
            order.Action = action;
            order.OrderType = "PEG STK";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::auctionrelative::csharp
            Order order = new Order();
            order.Action = action;
            order.OrderType = "REL";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::passiverelative::csharp
            Order order = new Order();
            order.Action = action;
        ...
        {
            //EXSTART::peggedtomidpoint::csharp
            Order order = new Order();
            order.Action = action;
        ...
        {
            //EXSTART::marketwithprotection::csharp
            Order order = new Order();
            order.Action = action;
        ...
        {
            //EXSTART::stopwithprotection::csharp
            Order order = new Order();
            order.TotalQuantity = quantity;
            order.Action = action;
        ...
        {
            //EXSTART::trailingstoplimit::csharp
            Order order = new Order();
            order.Action = action;
        ...
        {
            //EXSTART::combolimitorder::csharp
            Order order = new Order();
            order.Action = action;
            order.OrderType = "LMT";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::combomarketorder::csharp
            Order order = new Order();
            order.Action = action;
            order.OrderType = "MKT";
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::relativelimitcombo::csharp
            Order order = new Order();
            order.Action = action;
            order.TotalQuantity = quantity;
        ...
        {
            //EXSTART::relativemarketcombo::csharp
            Order order = new Order();
            order.Action = action;
            order.TotalQuantity = quantity;
